...
;; rational number test
 ...
 (rat-op-test-diff1 "op((5 / 2), (3 / 5), 4)" (19 . 10))
 (rat-op-test-diff2 "op((5 / 2), 4, 4)" (-3 . 2))
 (rat-op-test-diff3 "op(3, (3 / 5), 4)" (12 . 5))

 (rat-if-1 "if zero?((0 / 4)) then 1 else 0" 1)
 (rat-if-2 "if zero?(op((7 / 4), op((5 / 2), 4, 4), 4)) then (7 / 4) else 0" 0)
